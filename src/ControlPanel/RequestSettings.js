    ...
    return (
      <form onSubmit={this.handleSubmit.bind(this)} ref='form'>
        ...
        <div className='form-group'>
          ...
          <input type='number' id='top' className='form-control' aria-describedby='topHelp' placeholder='Number of results to return, default is 50' />
          <small id='topHelp' className='form-text text-muted'>Specifying a value greater than 1000 and there are more than 1000 results, only the first 1000 results will be returned, along with a link to the next page of results.</small>
        </div>
        <div className='form-group'>
          <label htmlFor='queryType'>Query Type</label>
          <select id='queryType' className='form-control' aria-describedby='queryTypeHelp' required value={this.state.queryType} onChange={this.changeQueryType}>
        ...
        <ul>
          ...
          <li>Paging</li>
          <li>Highlight pre/post tag, limit (requires schema)</li>
          <li>Sorting</li>
